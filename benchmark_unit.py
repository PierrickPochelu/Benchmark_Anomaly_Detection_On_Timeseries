...
# Let's compare a simple strategy on all datasets
import os
...
/home/pierrick/PycharmProjects/anomaly_detection/normalize_data.py:6: RuntimeWarning: invalid value encountered in true_divide
